...
void main() {
  test('Item toMap and fromMap roundtrip', () {
    ...
    final item = Item(id: '42', name: 'Milk', timestamp: timestamp, checked: true, owner: 'tester', list: '1');
    ...
    expect(item2.owner, item.owner);
    expect(item2.list, item.list);
  });
}
